...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen bg-[#1a1a2e] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-32 sm:pt-40 md:pt-48 lg:pt-56 pb-12 sm:pb-16 md:pb-20">
        <div className="max-w-3xl">
          ...
          <a 
            ...
            className="inline-block bg-[#1a1a2e] border border-white text-white px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg text-sm sm:text-base md:text-lg font-semibold hover:bg-white hover:text-[#1a1a2e] transition-colors"
          >
            Our Story
          </a>
        </div>
