  ...
  return (
    <section id="how-it-works" className="py-16 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1a1a2e] mb-12 sm:mb-16">How It Works</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-[#1a1a2e]">The Future of Energy</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#374151]">No fuel required.</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-[#10b981] rounded-full"></div>
                <span className="text-[#374151]">Works in any climate.</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-[#10b981] rounded-full"></div>
                <span className="text-[#374151]">Scalable technology.</span>
              </div>
            </div>
          </div>
        </div>
