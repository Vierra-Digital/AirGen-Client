    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1a1a2e] mb-4 sm:mb-6">About Us</h2>
          <p className="text-base sm:text-lg text-[#374151] max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div className="space-y-4 md:space-y-6">
            <h3 className="text-xl sm:text-2xl font-bold text-[#1a1a2e]">Our Mission</h3>
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-[#1a1a2e]">Our Vision</h3>
            <p className="text-sm sm:text-base text-[#374151] leading-relaxed">
          ...
          <div className="space-y-4 md:space-y-6">
            <h3 className="text-xl sm:text-2xl font-bold text-[#1a1a2e]">Our Technology</h3>
            <p className="text-sm sm:text-base text-[#374151] leading-relaxed">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-[#1a1a2e]">Our Impact</h3>
            <p className="text-sm sm:text-base text-[#374151] leading-relaxed">
